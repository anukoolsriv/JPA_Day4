...
public class Main_5 {
	...
	public static void main(String[] args) {
		...
		loadData();	
		String name = "Sachin";
		String jpql = "SELECT e from Employee e where e.employeeSalary > (Select e1.employeeSalary from Employee e1 where e1.employeeName = :name)";
...
//			System.out.println("Department City: " + e.getDepartment().getCity());
	...
	public static void loadData() {
		...
		Employee emp1 = new Employee(121, "Sachin", 2300);
